...
public class MulEnemy_Ani : MonoBehaviour {
	...
	void Start () {
        ...
        {
            m_EnemyPlayer = GameObject.FindWithTag("Enemy").GetComponent<MulEnemy>();

            State = MultiGameManager.NowGameState;
            ControlState = MultiGameManager.NowGameControlState;

            //PlayerAniState = m_EnemyPlayer.GetEnemyAniState();

            this.transform.position = new Vector3(m_EnemyPlayer.gameObject.transform.position.x, m_EnemyPlayer.gameObject.transform.position.y + 0.2f, m_EnemyPlayer.gameObject.transform.position.z);
        }
        else
        {
            State = MultiGameManager.NowGameState;
    ...
    void Update()
    {
        ...
        switch (State)
        {
            case GameState.START:
                {
                    this.transform.position = new Vector3(m_EnemyPlayer.gameObject.transform.position.x, m_EnemyPlayer.gameObject.transform.position.y, m_EnemyPlayer.gameObject.transform.position.z);
                }
                break;
